...
tools_fix = [
                    ...
                    [30, "Particular Scanner found multiple vulnerabilities that an attacker may try to exploit the target.",
                            "Refer to John-oseni-Vulnerability-Report to view the complete information of the vulnerability, once the scan gets completed."],
...
if args_namespace.help or (not args_namespace.update \
    ...
    if len(rs_vul_list)==0:
        ...
        with open("John-Oseni-Vulnerability-Report", "a") as report:
            ...
            print("\tComplete Vulnerability Report for "+bcolors.OKBLUE+target+bcolors.ENDC+" named "+bcolors.OKGREEN+"`John-Oseni-Vulnerability-Report`"+bcolors.ENDC+" is available under the same directory WebScan resides.")
